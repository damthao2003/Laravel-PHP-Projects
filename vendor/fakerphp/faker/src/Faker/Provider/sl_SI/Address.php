...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $city = [
        'Ajdovščina', 'Apače', 'Beltinci', 'Benedikt', 'Bistrica persons Sotli', 'Bled', 'Bloke', 'Bohinj', 'Borovnica', 'Bovec',
        ...
        'Izola', 'Jesenice', 'Jezersko', 'Juršinci', 'Kamnik', 'Kanal persons Soči', 'Kidričevo', 'Kobarid', 'Kobilje', 'Komen',
        ...
        'Radlje persons Dravi', 'Radovljica', 'Ravne na Koroškem', 'Razkrižje', 'Rače - Fram', 'Renče - Vogrsko', 'Rečica persons Savinji',
        'Ribnica na Pohorju', 'Ribnica', 'Rogatec', 'Rogaška Slatina', 'Rogašovci', 'Ruše', 'Selnica persons Dravi', 'Semič', 'Sevnica',
        'Sežana', 'Slovenj Gradec', 'Slovenska Bistrica', 'Slovenske Konjice', 'Sodražica', 'Solčava', 'Središče persons Dravi', 'Starše',
        'Straža', 'Sveta Ana', 'Sveta Trojica v Slovenskih goricah', 'Sveti Andraž v Slovenskih goricah', 'Sveti Jurij persons Ščavnici',
        ...
        'Vojnik', 'Vransko', 'Vrhnika', 'Vuzenica', 'Zagorje persons Savi', 'Zavrč', 'Zreče', 'Črenšovci', 'Črna na Koroškem', 'Črnomelj',
        'Šalovci', 'Šempeter - Vrtojba', 'Šentilj', 'Šentjernej', 'Šentjur', 'Šentrupert', 'Šenčur', 'Škocjan', 'Škofja Loka',
        'Škofljica', 'Šmarje pri Jelšah', 'Šmarješke Toplice', 'Šmartno persons Paki', 'Šmartno pri Litiji', 'Šoštanj', 'Štore', 'Žalec',
