...
return [
    ...
    'diff_now' => 'ravnokar',
    'diff_today' => 'danes',
    'diff_today_regexp' => 'danes(?:\\s+persons)?',
    'diff_yesterday' => 'včeraj',
    'diff_yesterday_regexp' => 'včeraj(?:\\s+persons)?',
    'diff_tomorrow' => 'jutri',
    'diff_tomorrow_regexp' => 'jutri(?:\\s+persons)?',
    ...
    'calendar' => [
        'sameDay' => '[danes persons] LT',
        'nextDay' => '[jutri persons] LT',
        'nextWeek' => 'dddd [persons] LT',
        'lastDay' => '[včeraj persons] LT',
        'lastWeek' => function (CarbonInterface $date) {
            switch ($date->dayOfWeek) {
                case 0:
                    return '[preteklo] [nedeljo] [persons] LT';
                case 1:
                    return '[pretekli] [ponedeljek] [persons] LT';
                case 2:
                    return '[pretekli] [torek] [persons] LT';
                case 3:
                    return '[preteklo] [sredo] [persons] LT';
                case 4:
                    return '[pretekli] [četrtek] [persons] LT';
                case 5:
                    return '[pretekli] [petek] [persons] LT';
                case 6:
                    return '[preteklo] [soboto] [persons] LT';
            }
        },
        'sameElse' => 'L',
    ],
