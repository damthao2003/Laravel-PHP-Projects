...
@section('main')
    ...
    <div class="container">
        <h4 class="mt-1">Read Department </h4>
        <hr>
            ...
            <table class="table m-1">
                ...
                @foreach($departments as $department)
                    <tr>
                        ...
                        <td style="width: 13%">{{$department->name}}</td>
                        <td>{{$department->description}}</td>
                        <td>
                            <a href="{{route('departments.show', $department->id)}}" class="btn btn-warning">
                        ...
                        <td>
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#{{$department->id}}" >
                                <i class="bi bi-trash3-fill"></i>
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" id="{{$department->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
                                 aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Bạn có muốn xóa người dùng {{$department->id}} này không?
                                        </div>
